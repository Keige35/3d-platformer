...
public class CharacterJumpFallState : State
{
    ...
    public CharacterJumpFallState(CharacterAnimatorController characterAnimationController, InputManager inputManager, Rigidbody rigidBody,ParticleSystem particleSystem, float speed, float speedRotate, float forceJump)
    {
